...
let odomDataFeedback = require('./odomDataFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class odomDataActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new odomDataFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = odomDataFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new odomDataActionFeedback(null);
    ...
    data.feedback = odomDataFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += odomDataFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new odomDataActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = odomDataFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new odomDataFeedback()
    }
...
module.exports = odomDataActionFeedback;
