...
let odomDataGoal = require('./odomDataGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class odomDataActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = odomDataGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new odomDataActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = odomDataGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new odomDataGoal()
    }
...
module.exports = odomDataActionGoal;
