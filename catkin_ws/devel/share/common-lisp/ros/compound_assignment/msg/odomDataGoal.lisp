...
(cl:defmethod cl:initialize-instance :after ((m <odomDataGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'odomDataGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name compound_assignment-msg:<odomDataGoal> is deprecated: use compound_assignment-msg:odomDataGoal instead.")))

(cl:ensure-generic-function 'seconds-val :lambda-list '(m))
(cl:defmethod seconds-val ((m <odomDataGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compound_assignment-msg:seconds-val is deprecated.  Use compound_assignment-msg:seconds instead.")
  (seconds m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<odomDataGoal>)))
  ...
  "compound_assignment/odomDataGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'odomDataGoal)))
  "Returns string type for a message object of type 'odomDataGoal"
  "compound_assignment/odomDataGoal")
